    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="max-w-4xl p-8 text-center">
        <h1 className="text-5xl font-bold mb-6 text-white bg-clip-text">
          RL Trajectory Generation from EHR Data
        </h1>
        <div className="relative rounded-lg overflow-hidden shadow-2xl mb-6">
          {isLoading ? (
            ...
            <img
              ...
              alt="EHR Data Trajectory Visualization"
        ...
        <p className="text-xl text-gray-300 mb-8">
          Transform your Electronic Health Records into meaningful reinforcement learning trajectories
        </p>
        <WaitlistForm />
        <ContactSection />
      </div>
